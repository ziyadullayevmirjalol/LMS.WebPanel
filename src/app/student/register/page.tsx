            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-cyan-950 to-slate-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    <div className="bg-white/5 backdrop-blur-xl py-10 px-6 shadow-2xl sm:rounded-2xl border border-white/10 text-center">
                        ...
                        <Link
                            href="/student/login"
                            className="inline-flex items-center justify-center py-2.5 px-6 border border-transparent rounded-lg shadow-lg shadow-cyan-500/25 text-sm font-semibold text-white bg-cyan-600 hover:bg-cyan-500 transition"
                        >
                            Log in to Account
                        </Link>
                    </div>
                ...
                <div className="bg-white/5 backdrop-blur-xl py-8 px-4 shadow-2xl sm:rounded-2xl sm:px-10 border border-white/10">
                    <form className="space-y-6" onSubmit={handleRegister}>
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs text-cyan-300/40">Minimum 6 characters</p>
                        </div>
